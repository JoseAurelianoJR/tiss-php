...
if (!class_exists("ct_procedimentoExecutadoInt", false)) 
{
class ct_procedimentoExecutadoInt
{
  ...
  /**
   * 
   * @var identEquipe $identEquipe
   * @access public
   */
  public $identEquipe = null;
   ...
   * @param identEquipe $identEquipe
   * @access public
   */
  public function __construct($dataExecucao, $horaInicial, $horaFinal, $procedimento, $quantidadeExecutada, $viaAcesso, $tecnicaUtilizada, $reducaoAcrescimo, $valorUnitario, $valorTotal, $identEquipe)
  {
